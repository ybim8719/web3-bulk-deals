...
contract NftLuckyDipTest is Test {
    ...
    function testOwnerCanAddLuckyDip() public {
        ...
        vm.prank(msg.sender);
        s_luckyDip.addLuckyDip(ADDITIONNAL_MOCK_DESCRIPTION, ADDITIONNAL_MOCK_SYMBOL, ADDITIONNAL_MOCK_NAME, ADDITIONNAL_MOCK_STARTINGBID, ADDITIONNAL_MOCK_BIDSTEP, s_tmpImageUris);
