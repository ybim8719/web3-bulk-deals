...
contract NftLuckyDipTest is Test {
    ...
    string constant MOCK_LUCKY_DIP_DESCRIPTION = "A nice collection from Jean Michel Mock";
    ...
    function testLuckyDipAddingWorks() public view {
        ...
        assertEq(luckyDip.getLuckyDipNFTLength(0), MOCK_LUCKY_DIP_IMAGE_URI_LENGTH);
        ...
        assertEq(luckyDip.getLuckyDipDescription(0), MOCK_LUCKY_DIP_DESCRIPTION);
        assertEq(luckyDip.getStartingBid(0), MOCK_LUCKY_DIP_STARTINGBID);
        assertEq(luckyDip.getNextBiddingPriceInWei(0), (MOCK_LUCKY_DIP_STARTINGBID + (0 * MOCK_LUCKY_DIP_BIDSTEP)));
    }
